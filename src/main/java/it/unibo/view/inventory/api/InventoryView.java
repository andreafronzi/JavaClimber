...
public interface InventoryView {
    ...
    /**
     * Update the inventory view with the current state of owned skins, equipped skin, permanent items, selected jump and speed levels, owned temporary items, their active status, and remaining duration.
